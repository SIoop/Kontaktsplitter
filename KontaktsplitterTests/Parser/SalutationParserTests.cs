...
namespace KontaktsplitterTests.Parser
{
    ...
    public class SalutationParserTests
    {
        ...
        public void MutlipleTitlesGermanNameTest()
        {
            ...
            Assert.AreEqual(kunde.Anrede, "Herrn Dr. Ing. Dr. rer. nat.");
            Assert.AreEqual(kunde.Geschlecht, Geschlecht.Männlich);
            Assert.AreEqual(kunde.Nachname, "Steffens");
            Assert.AreEqual(kunde.Vorname, "Paul");
            Assert.AreEqual(kunde.Titel, "Dr. Ing. Dr. rer. nat.");
            Assert.AreEqual(kunde.Briefanrede, "Sehr geehrter Herr Dr. Ing. Dr. rer. nat.");
        }
    }
}